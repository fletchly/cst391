    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                <div className={"position-sticky top-0 bg-body shadow-sm d-flex align-items-center"}>
                    ...
                    <input placeholder={"Title"} className={"m-1 note-title text-dark border border-dark rounded-2"}
                ...
                <div className={"p-3"}>
                    {preview ?
                        ...
                        :
                        <div>
                            <textarea placeholder={"Write here..."} onLoad={autoGrow} id={"noteContent"} className={"note-content font-monospace"} onChange={handleChange} name={"content"} value={note.content}/>
                        </div>
                    }
                </div>
            </form>
                ...
                <div className={"modal-dialog"}>
                    <div className={"modal-content"}>
                        ...
                        <div className={"modal-footer"}>
                            ...
                            <button type={"button"} className={"btn btn-outline-danger"} data-bs-dismiss={"modal"} onClick={handleDelete}>Delete</button>
                        </div>
                    </div>
                </div>
            </div>
